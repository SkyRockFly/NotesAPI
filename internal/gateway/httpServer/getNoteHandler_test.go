	...
	tests := []struct {
	...
	}{
		{
			...
			req: wantReq{
				...
				body:   `{"id":1,"account_id":101}`,
			},
			want: wantResp{
				code: http.StatusOK,
				body: `{"id":1,"account_id":101,"title":"kek","body":"cheburek",
"created_at":"2025-09-12T10:00:00Z","updated_at":"2025-09-12T10:00:00Z"}`,
			},
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			repo.On("Get", mock.Anything, 1, 101).
			...
			repo.On("Get", mock.Anything, 2, 202).
